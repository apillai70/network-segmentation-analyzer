...
class SolutionsArchitectureDocument:
    ...
    def generate_document(self, output_path: str):
        ...
        logger.info(f"[OK] Solutions Architecture Document saved: {output_path}")
...
def generate_solutions_document(
    ...
    logger.info(f"[SUCCESS] Solutions Architecture Document generated: {output_path}")
    return output_path
...
if __name__ == '__main__':
    ...
    print(f"\n[SUCCESS] Document generated: {doc_path}")
